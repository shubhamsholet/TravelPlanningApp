import{a as ge}from"./chunk-MBJXFQQZ.js";import{c as N,d as B}from"./chunk-2QODGAY2.js";import{a as me}from"./chunk-HUTYSJ3T.js";import{b as I,f as T,i as E,p as L,q as te,s as ne,v as ie}from"./chunk-Q45AA772.js";import{a as pe,b as ue}from"./chunk-6OM4G5IL.js";import{a as j,b as Q}from"./chunk-EA4NVXWS.js";import{a as V,b as A,c as U,d as se,e as z,f as de,g as le,h as ce,i as R}from"./chunk-6MQC3ILS.js";import{$a as Y,Ba as l,Ca as t,Da as n,Ea as y,Hb as O,Hc as ae,Ib as S,J as f,Jc as oe,K as h,Kc as re,La as v,Lb as X,Lc as F,Mb as Z,Na as g,Nb as D,Pa as m,U as p,Xb as ee,ba as q,bb as o,ca as r,cb as _,db as b,fb as M,gb as w,hb as k,ia as K,ma as C,mb as H,nb as $,ob as P,qa as u,qb as J,rb as G}from"./chunk-4ILKLGUS.js";function we(i,a){if(i&1&&(t(0,"div",11)(1,"div",12)(2,"span"),o(3),n(),t(4,"small",13),o(5),P(6,"date"),n()()()),i&2){let e=a.$implicit;Y("user-message",e.isUser)("bot-message",!e.isUser),r(3),_(e.text),r(2),_(J(6,6,e.timestamp,"shortTime"))}}function ke(i,a){i&1&&(t(0,"div",14)(1,"div",15)(2,"span"),o(3,"."),n(),t(4,"span"),o(5,"."),n(),t(6,"span"),o(7,"."),n()()())}function Pe(i,a){if(i&1){let e=v();t(0,"div",3)(1,"mat-card")(2,"mat-card-header")(3,"mat-icon",4),o(4,"flight_takeoff"),n(),t(5,"mat-card-title"),o(6,"Travel Assistant"),n(),t(7,"mat-card-subtitle"),o(8,"I only answer travel & destination questions! \u2708\uFE0F"),n()(),t(9,"mat-card-content",5),u(10,we,7,9,"div",6)(11,ke,8,0,"div",7),n(),t(12,"mat-card-actions")(13,"div",8)(14,"input",9),k("ngModelChange",function(d){f(e);let c=m();return w(c.userInput,d)||(c.userInput=d),h(d)}),g("keyup.enter",function(){f(e);let d=m();return h(d.sendMessage())}),n(),t(15,"button",10),g("click",function(){f(e);let d=m();return h(d.sendMessage())}),t(16,"mat-icon"),o(17,"send"),n()()()()()()}if(i&2){let e=m();r(10),l("ngForOf",e.messages()),r(),l("ngIf",e.isLoading()),r(3),M("ngModel",e.userInput),l("disabled",e.isLoading()),r(),l("disabled",e.isLoading()||!e.userInput.trim())}}var W=class i{isOpen=p(!1);isLoading=p(!1);userInput="";messages=p([{text:`Hi! I'm your travel assistant \u2708\uFE0F
...
How can I help you today?`,isUser:!1,timestamp:new Date}]);travelKeywords=["destination","travel","trip","vacation","holiday","tour","hotel","flight","booking","budget","price","cost","packing","weather","food","visa","passport","attraction","activity","beach","mountain","city","country","tourism","tourist","journey","adventure","plan","recommend","suggest","visit"];destinationResponses={"Bali,indonesia":`Bali \u{1F334} is amazing! Best time: April-Oct (dry season).
...
Budget: $30-100/day.`,"Tokyo,japan":`Tokyo \u{1F5FC} is incredible! Best time: March-April or Oct-Nov.
...
Food is amazing and affordable!`,"New York,usa":`New York \u{1F5FD} never sleeps!
...
\u2022 Times Square
\u2022 Central Park
\u2022 Statue of Liberty`,"Rome,italy":`Rome \u{1F3DB}\uFE0F is historic! Best time: April-June or Sept-Oct.

Must visit:
\u2022 Colosseum
\u2022 Vatican Museums
\u2022 Trevi Fountain`,"Dubai,uae":`Dubai \u{1F3D9}\uFE0F is futuristic! Best time: Nov-March (cooler months).

Must visit:
\u2022 Burj Khalifa
\u2022 Dubai Mall
\u2022 Desert Safari`};unsupportedDestinations=["japan","london","dubai","singapore","maldives","thailand","rome","spain","switzerland","germany","canada","australia","korea","china","india"];responses={packing:`Essential packing items \u2708\uFE0F:
\u2022 Passport & documents
\u2022 Comfortable shoes
\u2022 Power bank
\u2022 Universal adapter
