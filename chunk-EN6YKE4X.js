import{a as ge}from"./chunk-MBJXFQQZ.js";import{c as N,d as A}from"./chunk-2QODGAY2.js";import{a as ce}from"./chunk-HUTYSJ3T.js";import{b as D,f as T,i as E,p as B,q as te,s as ne,v as ie}from"./chunk-Q45AA772.js";import{a as pe,b as ue}from"./chunk-6OM4G5IL.js";import{a as Y,b as z}from"./chunk-EA4NVXWS.js";import{a as U,b as F,c as V,d as se,e as R,f as de,g as le,h as me,i as j}from"./chunk-6MQC3ILS.js";import{$a as W,Ba as l,Ca as t,Da as n,Ea as C,Hb as O,Hc as ae,Ib as P,J as f,Jc as oe,K as h,Kc as re,La as x,Lb as Z,Lc as L,Mb as X,Na as g,Nb as I,Pa as c,U as p,Xb as ee,ba as J,bb as o,ca as r,cb as b,db as _,fb as M,gb as w,hb as k,ia as K,ma as y,mb as q,nb as H,ob as S,qa as u,qb as $,rb as G}from"./chunk-4ILKLGUS.js";function we(i,a){if(i&1&&(t(0,"div",11)(1,"div",12)(2,"span"),o(3),n(),t(4,"small",13),o(5),S(6,"date"),n()()()),i&2){let e=a.$implicit;W("user-message",e.isUser)("bot-message",!e.isUser),r(3),b(e.text),r(2),b($(6,6,e.timestamp,"shortTime"))}}function ke(i,a){i&1&&(t(0,"div",14)(1,"div",15)(2,"span"),o(3,"."),n(),t(4,"span"),o(5,"."),n(),t(6,"span"),o(7,"."),n()()())}function Se(i,a){if(i&1){let e=x();t(0,"div",3)(1,"mat-card")(2,"mat-card-header")(3,"mat-icon",4),o(4,"flight_takeoff"),n(),t(5,"mat-card-title"),o(6,"Travel Assistant"),n(),t(7,"mat-card-subtitle"),o(8,"I only answer travel & destination questions! \u2708\uFE0F"),n()(),t(9,"mat-card-content",5),u(10,we,7,9,"div",6)(11,ke,8,0,"div",7),n(),t(12,"mat-card-actions")(13,"div",8)(14,"input",9),k("ngModelChange",function(d){f(e);let m=c();return w(m.userInput,d)||(m.userInput=d),h(d)}),g("keyup.enter",function(){f(e);let d=c();return h(d.sendMessage())}),n(),t(15,"button",10),g("click",function(){f(e);let d=c();return h(d.sendMessage())}),t(16,"mat-icon"),o(17,"send"),n()()()()()()}if(i&2){let e=c();r(10),l("ngForOf",e.messages()),r(),l("ngIf",e.isLoading()),r(3),M("ngModel",e.userInput),l("disabled",e.isLoading()),r(),l("disabled",e.isLoading()||!e.userInput.trim())}}var Q=class i{isOpen=p(!1);isLoading=p(!1);userInput="";messages=p([{text:`Hi! I'm your travel assistant \u2708\uFE0F
...
How can I help you today?`,isUser:!1,timestamp:new Date}]);travelKeywords=["destination","travel","trip","vacation","holiday","tour","hotel","flight","booking","budget","price","cost","packing","weather","food","visa","passport","attraction","activity","beach","mountain","city","country","tourism","tourist","journey","adventure","plan","recommend","suggest","visit","japan"];destinationResponses={Bali:`Bali \u{1F334} is amazing! Best time: April-Oct (dry season).
...
Experience modern marvels and rich desert heritage!`};unsupportedDestinations=["london","dubai","singapore","maldives","thailand","spain","switzerland","germany","canada","australia","korea","china","india"];responses={packing:`Essential packing items \u2708\uFE0F:
\u2022 Passport & documents
\u2022 Comfortable shoes
\u2022 Power bank
\u2022 Universal adapter
...
Please ask something travel-related \u{1F30D}`;let d=Object.keys(this.destinationResponses).find(v=>e.includes(v));if(d)return this.destinationResponses[d];let m=this.unsupportedDestinations.find(v=>e.includes(v));return m?`Sorry \u{1F605} Currently we don't have travel plans or guides for ${m.charAt(0).toUpperCase()+m.slice(1)} yet.
